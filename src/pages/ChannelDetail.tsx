  ...
  const messages = [
    {
      ...
      avatar: sarahJohnson,
      content: "Welcome everyone to our community channel! Feel free to introduce yourself and share what brings you here.",
      timestamp: "10:30 AM",
    ...
    },
    {
      ...
      sender: "Michael Chen",
      avatar: michaelChen,
      content: "Thanks Sarah! I'm excited to be part of this community and looking forward to contributing to local events.",
      timestamp: "10:35 AM",
    ...
    },
    {
      ...
      content: "Great to see everyone here! Let's make this community amazing together.",
      timestamp: "10:42 AM",
      reactions: [],
    },
  ];
