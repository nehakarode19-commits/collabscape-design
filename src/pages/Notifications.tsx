...
const Notifications = () => {
  ...
  const [notifications, setNotifications] = useState([
    ...
    },
    {
      ...
      type: "event",
      icon: Calendar,
      title: "Community Cleanup Event Tomorrow",
      description: "Don't forget! The event starts at 9 AM at the community center.",
      time: "2 hours ago",
      read: false,
    ...
    },
    {
      ...
      description: "The community fundraiser has reached its goal of $5,000.",
      time: "1 day ago",
      read: true,
    ...
    },
    {
      ...
      type: "member",
      icon: Users,
      title: "Emily Rodriguez joined your chapter",
      description: "Welcome the new member to Downtown District chapter.",
      time: "2 days ago",
      read: true,
